...
client.on('message', message => {
 ...
 client.on('message', message => {
    ...
    const embed = new Discord.RichEmbed()
        .setColor("RANDOM")
        .setDescription("Done   | ✅ تم أرسال رابط السيرفر في الخاص ✅ |  on DM")
      message.channel.sendEmbed(embed).then(message => {message.delete(10000)})
              const Embed11 = new Discord.RichEmbed()
        .setColor("RANDOM")
        .setDescription("**| ✅ هذا الرابط صالح 24 ساعة ✅ |**”—")
...
const adminprefix = "-";
const devs = ['563408004133945377','539541145835929623'];
client.on('message', message => {
